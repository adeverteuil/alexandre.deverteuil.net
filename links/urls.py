...
from links.views import BookmarkArchiveIndex, BookmarkCreate, BookmarkUpdate, BookmarkDelete, BookmarkYearArchive, BookmarkDetail
...
urlpatterns = patterns('',
    ...
    url(r"^bookmark/(?P<pk>[0-9]+)/$", BookmarkDetail.as_view(), name="bookmark_detail"),
    url(r"^bookmark/add/$", BookmarkCreate.as_view(), name="bookmark_add"),
    url(r"^bookmark/(?P<pk>[0-9]+)/edit/$", BookmarkUpdate.as_view(), name="bookmark_update"),
